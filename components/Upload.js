...
const [category, setcategory] = useState()
  ...
  const YOUR_SERVER_URL = "https://dilipbackend.xyz/api/product-upload";
  useEffect(() => {
    (async () => {
      if (Platform.OS !== 'web') {
...
formData.append('password',password)
      ...
      const response = await fetch('http://dilipbackend.xyz/api/product-upload', {
        method: 'POST',
        body: formData,
        headers: {
    ...
    return (
      ...
      <Ionicons name="arrow-back-circle-outline" size={39} color="black" />
        ...
        <View style={{width:'90%',marginLeft:'auto',marginRight:'auto'}}>
            <Text style={{fontSize:28,marginTop:60,fontWeight:'bold'}}>Upload Product</Text>
